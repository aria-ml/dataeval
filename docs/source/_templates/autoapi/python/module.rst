...
.. autoapisummary::
   ...
   {{ exception.id }}
            ...
            {% set output_classes = visible_classes|selectattr("name","contains", "Output")|list %}
            {% set not_output_classes = visible_classes|reject('in',output_classes)|list %}
            {% if not_output_classes %}
