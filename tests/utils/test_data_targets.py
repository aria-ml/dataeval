...
class TestTargets:
    ...
    def test_targets_len(self):
        ...
        assert len(Targets(np.array([1]), np.array([1]), np.array([1]), np.array([1]))) == 1
    ...
    def test_targets_ic_at(self):
        ...
        np.array_equal(targets.at(0).labels, np.array([0]))
        np.array_equal(targets.at(1).labels, np.array([0]))
    ...
    def test_targets_od_at(self):
        ...
        np.array_equal(targets.at(0).labels, np.array([0]))
        np.array_equal(targets.at(1).labels, np.array([0, 1]))
