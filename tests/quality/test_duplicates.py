...
class TestDuplicates:
    ...
    def test_duplicates_with_stats(self):
        ...
        stats = calculate_stats(data, stats=ImageStats.HASH, per_image=True, per_target=False)
    ...
    def test_get_duplicates_multiple_stats(self):
        ...
        dupes1 = calculate_stats(data1, stats=ImageStats.HASH, per_image=True, per_target=False)
        dupes2 = calculate_stats(data2, stats=ImageStats.HASH, per_image=True, per_target=False)
        dupes3 = calculate_stats(data3, stats=ImageStats.HASH, per_image=True, per_target=False)
    ...
    def test_cross_dataset_with_targets(self, get_mock_od_dataset):
        ...
        stats1 = calculate_stats(dataset1, stats=ImageStats.HASH, per_image=True, per_target=True)
        stats2 = calculate_stats(dataset2, stats=ImageStats.HASH, per_image=True, per_target=True)
