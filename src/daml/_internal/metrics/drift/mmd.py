...
class MMDDrift(BaseDrift):
    ...
    update_x_ref : Optional[UpdateStrategy], default None
        ...
        :py:class:`daml.metrics.drift.LastSeenUpdateStrategy`
        or via reservoir sampling with
        :py:class:`daml.metrics.drift.ReservoirSamplingUpdateStrategy`.
    preprocess_fn : Optional[Callable], default None
        Function to preprocess the data before computing the data drift metrics.
    kernel : Callable, default :py:class:`daml.metrics.drift.GaussianRBF`
